...
def welcome_start(message):
    ...
    response = (
        f"🥀Welcome {user_name}!\n\n"
        " For User ID : /id \n\n"
        "👉 Join our official channel -@MAHADEVSANNIBot ✅\n\n"
        "👑 For access: @MAHADEVSANNIBot"
        "👑 OWNER : @MAHADEVSANNIBot"
    )
    bot.reply_to(message, response)
...
def clear_logs_handler(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "Only @MAHADEVSANNIBot can run this command.")
